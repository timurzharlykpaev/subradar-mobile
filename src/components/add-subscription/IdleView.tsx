...
export const QUICK_CHIPS = [
  ...
  { name: 'ChatGPT', letter: 'C', letterBg: '#10A37F', iconUrl: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128', amount: 20, currency: 'USD', billingPeriod: 'MONTHLY', category: 'AI_SERVICES', serviceUrl: 'https://chat.openai.com', cancelUrl: 'https://help.openai.com/en/articles/7232013', plans: [{ name: 'Plus', priceMonthly: 20, currency: 'USD' }, { name: 'Pro', priceMonthly: 200, currency: 'USD' }] },
