...
const styles = StyleSheet.create({
  ...
  container: { position: 'absolute', bottom: 100, left: 16, right: 16, backgroundColor: '#1a1a1a', borderRadius: 12, overflow: 'hidden', elevation: 24, zIndex: 1000, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8 },
