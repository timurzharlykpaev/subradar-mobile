...
export const BusinessIcon: React.FC<IconProps> = ({ size = 20, color = '#1D4ED8' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" accessible accessibilityLabel="Business">
