        ...
        <View style={[card, { padding: 16, overflow: 'hidden' }]}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 14 }}>
            ...
            <TouchableOpacity
              ...
              style={{ width: 44, height: 44, borderRadius: 22, backgroundColor: colors.primaryLight, borderWidth: 1, borderColor: colors.primary + '30', alignItems: 'center', justifyContent: 'center' }}
